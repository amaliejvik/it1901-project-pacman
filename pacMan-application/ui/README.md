...
As illustrated below in the first photo, our tests cover almost all of the PacManController.
...
![gameOver](/pacMan-application/docs/release3/jacoco3/gameOver.png)
